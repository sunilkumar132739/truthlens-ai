import { type Lesson, LessonCard } from "@/components/LessonCard";
import {
  type MisinfoType,
  MisinfoTypeCard,
} from "@/components/MisinfoTypeCard";
...
const MISINFO_TYPES: MisinfoType[] = [
  {
    id: "fake-news",
    icon: "📰",
    label: "Fake News",
  ...
  },
  {
    ...
    tagline:
      "Content exploiting fear, outrage, or pride to bypass rational thought",
...
const LESSONS: Lesson[] = [
  {
    ...
    description:
      "Fake news articles mimic legitimate journalism with professional-looking layouts, stolen logos, and credible-sounding domain names. They spread rapidly through social media shares before fact-checkers can respond.",
    descriptionHi:
      "फर्जी खबरें पेशेवर दिखने वाले लेआउट, चुराए गए लोगो और विश्वसनीय डोमेन नामों के साथ असली पत्रकारिता की नकल करती हैं।",
    examples: [
      {
  ...
  },
  {
    ...
    description:
      "Clickbait uses curiosity gaps, exaggerated language, and emotional triggers to make you click. The article rarely delivers what the headline promises, but by then you've already given them the engagement they wanted.",
    descriptionHi:
      "क्लिकबेट जिज्ञासा, अतिरंजित भाषा और भावनात्मक ट्रिगर का उपयोग करता है। लेख शायद ही कभी वह देता है जो हेडलाइन वादा करती है।",
    examples: [
      {
  ...
  },
  {
    ...
    description:
      "Emotional manipulation content is crafted to make you feel fear, anger, or pride so intensely that you stop thinking critically. Your emotional brain responds faster than your rational brain, making this technique extremely effective.",
    descriptionHi:
      "भावनात्मक हेरफेर की सामग्री आपको डर, गुस्सा या गर्व महसूस कराने के लिए बनाई जाती है ताकि आप आलोचनात्मक सोच बंद कर दें।",
    examples: [
      {
  ...
  },
  {
    ...
    description:
      "Deepfake technology uses AI to superimpose a person's face and voice onto another body or into fabricated scenes. Once detectable by odd facial movements, modern deepfakes are increasingly indistinguishable from real footage.",
    descriptionHi:
      "डीपफेक तकनीक AI का उपयोग करके किसी व्यक्ति के चेहरे और आवाज को नकली दृश्यों में जोड़ती है। आधुनिक डीपफेक असली फुटेज से अलग नहीं दिखते।",
    examples: [
      {
  ...
  },
  {
    ...
    description:
      "Satirical news sites like The Onion or Faking News publish humorous fake stories. Problems arise when readers share these stories without context — or when bad actors remove the satire label entirely.",
    descriptionHi:
      "The Onion जैसी व्यंग्य समाचार साइटें हास्यपूर्ण नकली कहानियाँ प्रकाशित करती हैं। समस्या तब होती है जब पाठक बिना संदर्भ के साझा करते हैं।",
    examples: [
      {
  ...
  },
  {
    ...
    description:
      "Context manipulation uses real images, real statistics, or real quotes — but strips them of context to support a false conclusion. This is one of the hardest types of misinformation to detect because the underlying facts are genuine.",
    descriptionHi:
      "संदर्भ हेरफेर असली तस्वीरें, असली आँकड़े, या असली उद्धरणों का उपयोग करता है — लेकिन उन्हें संदर्भ से हटाकर झूठे निष्कर्ष का समर्थन करता है।",
    examples: [
      {
...
type CategoryFilter = "all" | Lesson["category"];
const FILTER_TABS: { id: CategoryFilter; label: string; labelHi: string }[] = [
...
export function EducationPage() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-8" data-ocid="education.page">
      {/* Hero */}
      <motion.div
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,oklch(0.7_0.18_200/0.12),transparent_60%)]" />
        <div className="relative z-10 flex items-start justify-between gap-4 flex-wrap">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-9 h-9 rounded-lg bg-chart-1/15 border border-chart-1/30 flex items-center justify-center">
                <BookOpen size={18} className="text-chart-1" />
              </div>
              <Badge
                variant="outline"
                className="border-primary/30 text-primary text-xs"
              >
                {isHi ? "मीडिया साक्षरता" : "Media Literacy"}
              </Badge>
            </div>
            <h1 className="font-display font-bold text-2xl md:text-3xl text-foreground mb-2">
              {isHi ? "फ़ैक्ट-चेकिंग विशेषज्ञ बनें" : "Become a Fact-Checking Expert"}
            </h1>
            <p className="text-muted-foreground text-sm max-w-lg">
              {isHi
                ? "गलत सूचना के प्रकारों को पहचानना सीखें, हेरफेर की रणनीतियों को समझें, और डिजिटल मीडिया को आत्मविश्वास के साथ नेविगेट करें।"
                : "Learn to recognize misinformation types, understand manipulation tactics, and navigate digital media with confidence."}
            </p>
          </div>

          {/* Progress */}
          <div className="shrink-0 rounded-xl border border-chart-1/30 bg-chart-1/10 px-5 py-4 text-center min-w-[140px]">
            <div className="font-display font-bold text-3xl text-chart-1">
              {readIds.size}
            </div>
            <div className="text-xs text-muted-foreground mt-0.5">
              {isHi
                ? `${LESSONS.length} में से पढ़े`
                : `of ${LESSONS.length} lessons read`}
            </div>
      ...
      {/* Misinfo Type Overview */}
      <section>
        <div className="flex items-center gap-2 mb-4">
          <TrendingUp size={16} className="text-secondary" />
          <h2 className="font-display font-semibold text-base text-foreground">
            {isHi ? "मुख्य गलत सूचना प्रकार" : "Key Misinformation Types"}
          </h2>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3">
          {MISINFO_TYPES.map((type, i) => (
            <MisinfoTypeCard
              key={type.id}
              type={type}
              index={i}
      ...
      {/* Main content: Lessons + Tips sidebar */}
      <div
        id="lessons-section"
      ...
      >
        ...
        <section>
          ...
          <p className="text-xs text-muted-foreground mb-4">
            {isHi
              ? `${filteredLessons.length} पाठ उपलब्ध`
        ...
        <aside>
          ...
          >
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-lg bg-chart-5/20 border border-chart-5/30 flex items-center justify-center">
                <Lightbulb size={14} className="text-chart-5" />
              </div>
              <h3 className="font-display font-semibold text-sm text-foreground">
                {isHi ? "त्वरित सुझाव" : "Quick Tips"}
              </h3>
            </div>
            <p className="text-xs text-muted-foreground">
              {isHi
                ? "इन सरल आदतों से गलत सूचना के ज़्यादातर मामले रोके जा सकते हैं।"
                : "These simple habits stop most misinformation in its tracks."}
            </p>
            <ul className="space-y-3">
              {(isHi ? QUICK_TIPS.hi : QUICK_TIPS.en).map((tip, i) => (
